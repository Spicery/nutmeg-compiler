...
func main() {
	...
	pflag.BoolVar(&makeRules, "make-rewrite-rules", false, "Generate default rewrite rules YAML")
	...
	pflag.StringVar(&configFile, "rewrite-rules", "", "YAML file containing rewrite rules")
	...
	pflag.IntVar(&maxRewrites, "max-rewrites", 0, "Maximum number of rewrite iterations (0 = unlimited)")
