...
const NameGoto = "goto"
const NameIfNot = "if.not"
const NameIfSo = "if.so"
const NameIfSoReturn = "if.so.return"
const NameIfNotReturn = "if.not.return"
